        ...
        <div className="flex justify-content-center pb-8">
            <div className="w-full md:w-10 lg:w-8">
                <div className="flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 className="text-3xl font-bold m-0 text-900">Exam History</h1>
                        <p className="text-600 m-0">View your past attempts and progress</p>
                    </div>
                    <Link to="/dashboard">
                ...
                <Card className="shadow-2 border-round-xl">
                    {history.length === 0 ? (
                        <div className="text-center py-6">
                            <i className="pi pi-history text-4xl text-400 mb-3"></i>
                            <div className="text-900 font-medium text-xl mb-2">No History Yet</div>
                            <p className="text-600 mb-4">Start your first exam to see your progress here.</p>
                            <Link to="/dashboard">
                                <Button label="Start Exam" icon="pi pi-play" />
                            </Link>
                        </div>
                    ) : (
                        <DataTable value={history} stripedRows tableStyle={{ minWidth: '50rem' }}>
                            <Column field="timestamp" header="Date" body={dateBodyTemplate} sortable></Column>
                            <Column field="subjectId" header="Subject" body={subjectBodyTemplate} sortable></Column>
                            <Column field="totalQuestions" header="Questions" sortable className="text-center"></Column>
